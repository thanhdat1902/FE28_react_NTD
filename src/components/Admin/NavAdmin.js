    ...
    render() {
        ...
        return (
            <div className="col-2">
                < div className="vertical-nav bg-dark text-white" id="sidebar" >
                    <div className="py-4 px-3 mb-4 bg-dark text-white">
                        ...
                        <div className="media-body">
                            ...
                            <p className="font-weight-light text-muted mb-0">Front-end Web developer</p>
                        </div>
                    </div>
                ...
                <button id="sidebarCollapse" onClick={() => { this.handleToggle() }} type="button" className="btn btn-light bg-white rounded-pill shadow-sm px-4 mb-4"><i className="fa fa-bars mr-2" /><small className="text-uppercase font-weight-bold">Toggle</small></button>
            </div>
        );
    }
